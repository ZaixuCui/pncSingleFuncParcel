...
clear
MethodKong_Folder = '/data/jux/BBL/projects/pncSingleFuncParcel/Replication/Revision/SingleParcellation_Kong/';
...
system(['echo VA 1 >> ' ColorInfo_Atlas17]);
system(['echo 1 74 155 60 1 >> ' ColorInfo_Atlas17]);
system(['echo DM 1 >> ' ColorInfo_Atlas17]);
system(['echo 2 205 62 78 1 >> ' ColorInfo_Atlas17]);
system(['echo DA 1 >> ' ColorInfo_Atlas17]);
system(['echo 3 70 130 180 1 >> ' ColorInfo_Atlas17]);
system(['echo FP 1 >> ' ColorInfo_Atlas17]);
...
system(['echo DM 2 >> ' ColorInfo_Atlas17]);
...
system(['echo 9 220 248 164 1 >> ' ColorInfo_Atlas17]);
system(['echo DM 3 >> ' ColorInfo_Atlas17]);
system(['echo 10 255 152 213 1 >> ' ColorInfo_Atlas17]);
system(['echo FP 2 >> ' ColorInfo_Atlas17]);
