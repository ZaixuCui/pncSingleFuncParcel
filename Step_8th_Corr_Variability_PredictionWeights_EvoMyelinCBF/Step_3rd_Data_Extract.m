...
AgeWeights_rh_NoMedialWall_RandomCV = AgeWeights_RandomCV.w_Brain_Age_Abs_sum_rh(Index_r);
% load age weights permutation data
AgeWeights_RandomCV_Perm = load([EvoEtc_ResultsFolder '/PermuteData_SpinTest/AgePredictionWeight_Perm.mat']);
AgeWeights_RandomCV_Perm_All_NoMedialWall = [AgeWeights_RandomCV_Perm.bigrotl(:, Index_l) AgeWeights_RandomCV_Perm.bigrotr(:, Index_r)];
AgeWeights_RandomCV_Perm_rh_NoMedialWall = AgeWeights_RandomCV_Perm.bigrotr(:, Index_r);
...
CognitionWeights_rh_NoMedialWall_RandomCV = CognitionWeights_RandomCV.w_Brain_EFAccuracy_Abs_sum_rh(Index_r);
% load cognition weights permutation data
CognitionWeights_RandomCV_Perm = load([EvoEtc_ResultsFolder '/PermuteData_SpinTest/EFPredictionWeight_Perm.mat']);
CognitionWeights_RandomCV_Perm_All_NoMedialWall = [CognitionWeights_RandomCV_Perm.bigrotl(:, Index_l) CognitionWeights_RandomCV_Perm.bigrotr(:, Index_r)];
CognitionWeights_RandomCV_Perm_rh_NoMedialWall = CognitionWeights_RandomCV_Perm.bigrotr(:, Index_r);
...
save([EvoEtc_ResultsFolder '/AllData.mat'], ...
    ...
    'AgeWeights_rh_NoMedialWall_RandomCV', ...
    'AgeWeights_RandomCV_Perm_All_NoMedialWall', ...
    'AgeWeights_RandomCV_Perm_rh_NoMedialWall', ...
    'CognitionWeights_All_NoMedialWall_RandomCV', ...
    'CognitionWeights_rh_NoMedialWall_RandomCV', ...
    'CognitionWeights_RandomCV_Perm_All_NoMedialWall', ...
    'CognitionWeights_RandomCV_Perm_rh_NoMedialWall', ...
