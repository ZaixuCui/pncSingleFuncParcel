...
NonZeroIndex = find(Yeo17_Label ~= 0); % Removing medial wall
ARI_HongmingGroup_Yeo17 = rand_index(Hongming_Group_Label, Yeo17_Label, 'adjusted');
...
for i = 1:1000
  i
  ARI_HongmingGroupSpin_Yeo17(i) = rand_index(GroupAtlasLabel_Spin(:, i), Yeo17_Label, 'adjusted');
end
