...
ResultantFolder = [ResultsFolder '/Atlas_Homogeneity_Reliability/Homogeneity_HongmingGroupAtlas'];
mkdir(ResultantFolder);
Combined_DataFolder = [ReplicationFolder '/data/CombinedData'];
HongmingGroup_Mat_Path = [ResultsFolder '/SingleParcellation/SingleAtlas_Analysis/Group_AtlasLabel.mat'];
for i = 1:length(BBLID)
  ...
  ResultantFile = [ResultantFolder '/Homogeneity_GroupLabel_' num2str(BBLID(i)) '.mat'];
  ...
  if ~exist(ResultantFile, 'file')
    ...
    Cmd = ['qsub-run --sge "-l h_vmem=10G" matlab -nosplash -nodesktop -r ' ...
          ...
          'HongmingLabel_Data = load(''' HongmingGroup_Mat_Path ''');' ...
