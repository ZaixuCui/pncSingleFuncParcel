...
EFPrediction_ResFolder = [ReplicationFolder '/Revision/PredictionAnalysis/AtlasLoading/2Fold_RandomCV_EFAccuracy'];
...
% Permutation test
EFPrediction_Permutation_ResFolder = [ReplicationFolder '/Revision/PredictionAnalysis/AtlasLoading/2Fold_RandomCV_EFAccuracy_Permutation'];
for i = 0:999
    i
