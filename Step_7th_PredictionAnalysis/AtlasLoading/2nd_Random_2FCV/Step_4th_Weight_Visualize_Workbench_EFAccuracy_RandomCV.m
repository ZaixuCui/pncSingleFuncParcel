...
w_Brain_EFAccuracy_Abs_FirstPercent_All = zeros(1, 17734*17);
...
for i = 1:17
    ...
    EFAccuracyEffect_Folder = [ReplicationFolder '/Revision/GamAnalysis/AtlasLoading/CognitionEffects'];
    EFAccuracyEffects_Mat = load([EFAccuracyEffect_Folder, '/CognitionEffect_AtlasLoading_17_Network_', num2str(i), '.mat']);
