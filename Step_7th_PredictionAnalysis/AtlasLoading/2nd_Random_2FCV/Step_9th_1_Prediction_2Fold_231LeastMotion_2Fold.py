...
ResultantFolder = AtlasLoading_Folder + '/2Fold_RandomCV_Motion_231LeastMotion_2FCV';
...
ResultantFolder = AtlasLoading_Folder + '/2Fold_RandomCV_Age_231LeastMotion_2FCV';
os.mkdir(ResultantFolder);
...
ResultantFolder = AtlasLoading_Folder + '/2Fold_RandomCV_Permutation_Motion_231LeastMotion_2FCV';
...
ResultantFolder = AtlasLoading_Folder + '/2Fold_RandomCV_Permutation_Age_231LeastMotion_2FCV';
