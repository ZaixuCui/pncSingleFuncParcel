...
w_Brain_Age_FirstPercent = w_Brain_Age;
w_Brain_Age_FirstPercent(Sorted_IDs(1:round(length(Sorted_IDs) * 0.75))) = 0;
w_Brain_Age_FirstPercent_All = zeros(1, 17734*17);
...
for i = 1:17
    i
    w_Brain_Age_FirstPercent_I = w_Brain_Age_FirstPercent_All([(i - 1) * VertexQuantity + 1 : i * VertexQuantity]);
    % left hemi
