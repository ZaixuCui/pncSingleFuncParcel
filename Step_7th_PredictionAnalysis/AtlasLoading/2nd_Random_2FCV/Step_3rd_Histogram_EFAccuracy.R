...
ggplot(ActualData) +
    ...
    scale_x_continuous(limits = c(0.37, 0.50), breaks = c(0.37, 0.43, 0.49), labels = c('0.37', '0.43', '0.49'))
ggsave('/data/jux/BBL/projects/pncSingleFuncParcel/Replication/Revision/Figures/ActualCorr_EFAccuracy_RandomCV.pdf', width = 17, height = 15, dpi = 600, units = "cm");
...
ggsave('/data/jux/BBL/projects/pncSingleFuncParcel/Replication/Revision/Figures/PermutationCorr_EFAccuracy_RandomCV.pdf', width = 17, height = 15, dpi = 600, units = "cm");
