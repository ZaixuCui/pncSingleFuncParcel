...
SubjectsData = SubjectsData[Order[0:231],];
Motion = Motion[Order[0:231]];
ResultantFolder = AtlasLoading_Folder + '/2Fold_RandomCV_Motion_231LeastMotion_10FCV';
os.mkdir(ResultantFolder);
# Store sex, age for the calculation of partial correlation
Sex = Behavior_Mat['Sex'][Order[0:231]];
AgeYears = Behavior_Mat['AgeYears'][Order[0:231]];
...
AgeYears = AgeYears[Order[0:231]];
ResultantFolder = AtlasLoading_Folder + '/2Fold_RandomCV_Age_231LeastMotion_10FCV';
os.mkdir(ResultantFolder);
...
ResultantFolder = AtlasLoading_Folder + '/2Fold_RandomCV_Permutation_Motion_231LeastMotion_10FCV';
...
ResultantFolder = AtlasLoading_Folder + '/2Fold_RandomCV_Permutation_Age_231LeastMotion_10FCV';
