...
ResultantFolder = AtlasLoading_Folder + '/2Fold_RandomCV_Motion_100LeastMotion_10FCV';
...
ResultantFolder = AtlasLoading_Folder + '/2Fold_RandomCV_Age_100LeastMotion_10FCV';
os.mkdir(ResultantFolder);
...
ResultantFolder = AtlasLoading_Folder + '/2Fold_RandomCV_Permutation_Motion_100LeastMotion_10FCV';
...
ResultantFolder = AtlasLoading_Folder + '/2Fold_RandomCV_Permutation_Age_100LeastMotion_10FCV';
