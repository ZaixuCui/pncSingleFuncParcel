...
SubjectsData = SubjectsData[Order[0:200],];
Motion = Motion[Order[0:200]];
ResultantFolder = AtlasLoading_Folder + '/2Fold_RandomCV_Motion_200LeastMotion_10Fold';
# Store sex, age for the calculation of partial correlation
Sex = Behavior_Mat['Sex'][Order[0:200]];
AgeYears = Behavior_Mat['AgeYears'][Order[0:200]];
...
AgeYears = AgeYears[Order[0:200]];
ResultantFolder = AtlasLoading_Folder + '/2Fold_RandomCV_Age_200LeastMotion_10Fold';
...
ResultantFolder = AtlasLoading_Folder + '/2Fold_RandomCV_Permutation_Motion_200LeastMotion';
...
ResultantFolder = AtlasLoading_Folder + '/2Fold_RandomCV_Permutation_Age_200LeastMotion';
