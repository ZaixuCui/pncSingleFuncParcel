...
ResultantFolder = AtlasLoading_Folder + '/2Fold_RandomCV_Motion_100LeastMotion';
...
ResultantFolder = AtlasLoading_Folder + '/2Fold_RandomCV_Age_100LeastMotion';
...
ResultantFolder = AtlasLoading_Folder + '/2Fold_RandomCV_Permutation_Motion_100LeastMotion';
...
ResultantFolder = AtlasLoading_Folder + '/2Fold_RandomCV_Permutation_Age_100LeastMotion';
