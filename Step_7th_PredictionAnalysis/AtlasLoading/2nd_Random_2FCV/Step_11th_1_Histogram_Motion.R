...
# Actual accuracy
Actual_Data = readMat(paste0(PredictionFolder, '/AtlasLoading/2Fold_RandomCV_Motion/2Fold_RandomCV_ParCorr_MAE_Actual.mat'));
...
ggplot(ActualData) +
    ...
    scale_x_continuous(limits = c(0.52, 0.62), breaks = c(0.52, 0.57, 0.62), labels = c('0.52', '0.57', '0.62'))
ggsave('/data/jux/BBL/projects/pncSingleFuncParcel/Replication/Revision/Figures/ActualCorr_Motion_RandomCV.pdf', width = 17, height = 15, dpi = 600, units = "cm");

# Permutation test accuracy
Permutation_Data = readMat(paste0(PredictionFolder, '/AtlasLoading/2Fold_RandomCV_Permutation_Motion/2Fold_RandomCV_ParCorr_MAE_Permutation.mat'));
...
ggsave('/data/jux/BBL/projects/pncSingleFuncParcel/Replication/Revision/Figures/PermutationCorr_Motion_RandomCV.pdf', width = 17, height = 15, dpi = 600, units = "cm");
