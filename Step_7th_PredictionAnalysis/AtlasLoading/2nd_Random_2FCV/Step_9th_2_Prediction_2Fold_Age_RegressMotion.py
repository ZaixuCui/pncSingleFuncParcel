...
ResultantFolder = AtlasLoading_Folder + '/2Fold_RandomCV_Age_RegressMotion';
Ridge_CZ_Random_RegressCovariates.Ridge_KFold_RandomCV_MultiTimes(SubjectsData, AgeYears, Covariates, FoldQuantity, Alpha_Range, 100, ResultantFolder, 1, 0, 'all.q');

# Permutation test, 1,000 times
ResultantFolder = AtlasLoading_Folder + '/2Fold_RandomCV_Permutation_Age_RegressMotion';
Ridge_CZ_Random_RegressCovariates.Ridge_KFold_RandomCV_MultiTimes(SubjectsData, AgeYears, Covariates, FoldQuantity, Alpha_Range, 1000, ResultantFolder, 1, 1, 'all.q');
