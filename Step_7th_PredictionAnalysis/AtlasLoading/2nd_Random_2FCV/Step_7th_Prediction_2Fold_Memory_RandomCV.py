...
Behavior = Behavior_Mat['F3_Memory_Accuracy'];
Behavior = np.transpose(Behavior);
ResultantFolder = AtlasLoading_Folder + '/2Fold_RandomCV_MemoryAccuracy';
...
ResultantFolder = AtlasLoading_Folder + '/2Fold_RandomCV_Permutation_MemoryAccuracy';
