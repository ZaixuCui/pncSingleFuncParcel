...
Behavior = Behavior_Mat['Motion'];
Behavior = np.transpose(Behavior);
ResultantFolder = AtlasLoading_Folder + '/2Fold_RandomCV_Motion';
...
ResultantFolder = AtlasLoading_Folder + '/2Fold_RandomCV_Permutation_Motion';
