...
MotionPrediction_ResFolder_231LeastMotion = [ReplicationFolder '/Revision/PredictionAnalysis/AtlasLoading/2Fold_RandomCV_Motion_231LeastMotion'];
...
% Permutation test
MotionPrediction_Permutation_ResFolder_231LeastMotion = [ReplicationFolder '/Revision/PredictionAnalysis/AtlasLoading/2Fold_RandomCV_Permutation_Motion_231LeastMotion'];
for i = 0:999
    i
...
% Age prediction
ReplicationFolder = '/data/jux/BBL/projects/pncSingleFuncParcel/Replication';
AgePrediction_ResFolder_231LeastMotion = [ReplicationFolder '/Revision/PredictionAnalysis/AtlasLoading/2Fold_RandomCV_Age_231LeastMotion'];
...
% Permutation test
AgePrediction_Permutation_ResFolder_231LeastMotion = [ReplicationFolder '/Revision/PredictionAnalysis/AtlasLoading/2Fold_RandomCV_Permutation_Age_231LeastMotion'];
for i = 0:999
    i
