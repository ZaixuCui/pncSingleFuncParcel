...
AgePrediction_ResFolder = [ReplicationFolder '/Revision/PredictionAnalysis/AtlasLoading/2Fold_RandomCV_Age'];
...
% Permutation test
AgePrediction_Permutation_ResFolder = [ReplicationFolder '/Revision/PredictionAnalysis/AtlasLoading/2Fold_RandomCV_Age_Permutation'];
for i = 0:999
    i
