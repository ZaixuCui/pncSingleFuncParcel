...
EFAccuracyPrediction_SomatoSensory_ResFolder = [PredictionFolder ...
...
for i = 1:99
    ...
    EFAccuracyPrediction_Fold0_SomatoSensory = load([EFAccuracyPrediction_SomatoSensory_ResFolder '/Time_' num2str(i) '/Fold_0_Score.mat']);
    EFAccuracyPrediction_Fold1_SomatoSensory = load([EFAccuracyPrediction_SomatoSensory_ResFolder '/Time_' num2str(i) '/Fold_1_Score.mat']);
    ...
    [ParCorr_Actual_Fold0, ~] = partialcorr(Prediction_Fold0.Predict_Score', EFAccuracy_Fold0, ...
          [double(Age_Fold0) double(Sex_Fold0) double(Motion_Fold0) double(EFAccuracyPrediction_Fold0_SomatoSensory.Predict_Score')]);
    [ParCorr_Actual_Fold1, ~] = partialcorr(Prediction_Fold1.Predict_Score', EFAccuracy_Fold1, ...
          [double(Age_Fold1) double(Sex_Fold1) double(Motion_Fold1) double(EFAccuracyPrediction_Fold1_SomatoSensory.Predict_Score')]);
