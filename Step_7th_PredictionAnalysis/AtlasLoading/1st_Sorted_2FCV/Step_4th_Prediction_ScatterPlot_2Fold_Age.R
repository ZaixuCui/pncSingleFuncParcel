...
PredictionFolder <- paste0(WorkingFolder, '/AtlasLoading/2Fold_Sort_Age');
...
Fig <- Fig + 
       ...
       scale_y_continuous(limits = c(8, 23), breaks = c(8, 13, 18, 23))
Fig

ggsave('/data/jux/BBL/projects/pncSingleFuncParcel/Replication/Revision/Figures/AgePrediction_CorrACC.tiff', width = 17, height = 15, dpi = 600, units = "cm");
