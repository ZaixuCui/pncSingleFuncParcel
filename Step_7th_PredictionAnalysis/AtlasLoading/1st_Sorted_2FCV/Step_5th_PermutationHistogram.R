...
PermutationData$Line_y = as.numeric(seq(0,172,length.out=1000));
...
ggsave('/data/jux/BBL/projects/pncSingleFuncParcel/Replication/Revision/Figures/Permutation_Age_Corr_Fold0.pdf', width = 17, height = 15, dpi = 600, units = "cm");
...
ggplot(PermutationData) +
    ...
    scale_y_continuous(expand = c(0, 0)) +
    scale_x_continuous(limits = c(-0.4, 0.70), breaks = c(-0.4, 0, 0.4), labels = c('-0.4', '0', '0.4'))
ggsave('/data/jux/BBL/projects/pncSingleFuncParcel/Replication/Revision/Figures/Permutation_Age_Corr_Fold1.pdf', width = 17, height = 15, dpi = 600, units = "cm");
...
ggsave('/data/jux/BBL/projects/pncSingleFuncParcel/Replication/Revision/Figures/Permutation_EFAccuracy_Corr_Fold0.pdf', width = 17, height = 15, dpi = 600, units = "cm");
...
ggplot(PermutationData) +
    ...
    scale_y_continuous(expand = c(0, 0)) +
    scale_x_continuous(limits = c(-0.3, 0.50), breaks = c(-0.3, 0, 0.3), labels = c('-0.3', '0', '0.3'))
ggsave('/data/jux/BBL/projects/pncSingleFuncParcel/Replication/Revision/Figures/Permutation_EFAccuracy_Corr_Fold1.pdf', width = 17, height = 15, dpi = 600, units = "cm");
