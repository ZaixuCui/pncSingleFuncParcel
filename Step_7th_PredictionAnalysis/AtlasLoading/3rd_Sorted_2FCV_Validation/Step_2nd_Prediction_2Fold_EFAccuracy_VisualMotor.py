...
ResultantFolder = AtlasLoading_Folder + '/2Fold_Sort_EFAccuracy_VisualMotor';
...
ResultantFolder = AtlasLoading_Folder + '/2Fold_Sort_Permutation_EFAccuracy_VisualMotor';
