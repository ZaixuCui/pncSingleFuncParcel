...
ResultantFolder = AtlasLoading_Folder + '/2Fold_RandomCV_Age';
Ridge_CZ_Random.Ridge_KFold_RandomCV_MultiTimes(SubjectsData, AgeYears, FoldQuantity, Alpha_Range, 100, ResultantFolder, 1, 0, 'all.q,basic.q');

# Permutation test, 1,000 times
ResultantFolder = AtlasLoading_Folder + '/2Fold_RandomCV_Age_Permutation';
Ridge_CZ_Random.Ridge_KFold_RandomCV_MultiTimes(SubjectsData, AgeYears, FoldQuantity, Alpha_Range, 1000, ResultantFolder, 1, 1, 'all.q,basic.q')
