...
PermutationData$Line_x = as.numeric(matrix(0.70, 1, 1000));
...
ggplot(PermutationData) +
    ...
    scale_x_continuous(limits = c(-0.4, 0.73), breaks = c(-0.4, 0, 0.4), labels = c('-0.4', '0', '0.4'))
ggsave('/data/jux/BBL/projects/pncSingleFuncParcel/Replication/results/Figures/Permutation_Age_Corr_Fold0.pdf', width = 17, height = 15, dpi = 600, units = "cm");
...
PermutationData$Line_x = as.numeric(matrix(0.73, 1, 1000));
PermutationData$Line_y = as.numeric(seq(0,201,length.out=1000));
ggplot(PermutationData) +
    ...
    scale_y_continuous(expand = c(0, 0)) +
    scale_x_continuous(limits = c(-0.4, 0.73), breaks = c(-0.4, 0, 0.4), labels = c('-0.4', '0', '0.4'))
ggsave('/data/jux/BBL/projects/pncSingleFuncParcel/Replication/results/Figures/Permutation_Age_Corr_Fold1.pdf', width = 17, height = 15, dpi = 600, units = "cm");
...
Corr_Fold0_Rand = Prediction_Fold0$ParCorr.Rand.Fold0;
PermutationData = data.frame(x = t(Corr_Fold0_Rand));
PermutationData$Line_x = as.numeric(matrix(0.45, 1, 1000));
PermutationData$Line_y = as.numeric(seq(0,123,length.out=1000));
ggplot(PermutationData) +
    geom_histogram(aes(x = x), bins = 30, color = "#7F7F7F", fill = "#7F7F7F") +
    geom_line(aes(x = Line_x, y = Line_y, group = 1), size = 1, color = 'red', linetype = "dashed") +
    theme_classic() + labs(x = "", y = "") +
...
ggsave('/data/jux/BBL/projects/pncSingleFuncParcel/Replication/results/Figures/Permutation_EFAccuracy_Corr_Fold0.pdf', width = 17, height = 15, dpi = 600, units = "cm");
...
Corr_Fold1_Rand = Prediction_Fold1$ParCorr.Rand.Fold1;
PermutationData = data.frame(x = t(Corr_Fold1_Rand));
PermutationData$Line_x = as.numeric(matrix(0.50, 1, 1000));
...
ggplot(PermutationData) +
    ...
    scale_y_continuous(expand = c(0, 0)) +
    scale_x_continuous(limits = c(-0.3, 0.50), breaks = c(-0.3, 0, 0.3), labels = c('-0.3', '0', '0.3'))
ggsave('/data/jux/BBL/projects/pncSingleFuncParcel/Replication/results/Figures/Permutation_EFAccuracy_Corr_Fold1.pdf', width = 17, height = 15, dpi = 600, units = "cm");
