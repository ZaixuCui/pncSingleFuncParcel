...
ParcellationFolder = [ReplicationFolder '/results/SingleAtlas_Analysis'];
...
PermuteData_Folder = [ReplicationFolder '/results/SingleParcellation/SingleAtlas_Analysis/Group_AtlasLoading_SpinPermutateData/PermuteData'];
