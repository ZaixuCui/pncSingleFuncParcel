...
save([MemoryPrediction_ResFolder '/ParCorr.mat'], 'ParCorr_Actual_Fold0', 'ParCorr_Actual_Fold1', ...
        'ParCorr_Actual_Mean');

%% Significance
MemoryAccuracyPrediction_PermutationFolder = [PredictionFolder '/AtlasLoading/2Fold_Sort_Permutation_MemoryAccuracy'];
% Fold 0
Permutation_Fold0_Cell = g_ls([MemoryAccuracyPrediction_PermutationFolder '/Time_*/Fold_0_Score.mat']);
for i = 1:1000
...
save([MemoryPrediction_ResFolder '/2Fold_Sort_Fold0_Specificity_Sig_MemoryAccuracy.mat'], 'ParCorr_Actual_Fold0', 'ParCorr_Rand_Fold0', 'ParCorr_Fold0_Sig', 'MAE_Actual_Fold0', 'MAE_Rand_Fold0', 'MAE_Fold0_Sig');
% Fold 1
Permutation_Fold1_Cell = g_ls([MemoryAccuracyPrediction_PermutationFolder '/Time_*/Fold_1_Score.mat']);
for i = 1:1000
...
save([MemoryPrediction_ResFolder '/2Fold_Sort_Fold1_Specificity_Sig_MemoryAccuracy.mat'], 'ParCorr_Actual_Fold1', 'ParCorr_Rand_Fold1', 'ParCorr_Fold1_Sig', 'MAE_Actual_Fold1', 'MAE_Rand_Fold1', 'MAE_Fold1_Sig');
