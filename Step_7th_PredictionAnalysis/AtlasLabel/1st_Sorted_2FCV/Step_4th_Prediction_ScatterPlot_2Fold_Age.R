...
PredictionFolder <- paste0(WorkingFolder, '/AtlasLabel/2Fold_Sort_Age');
...
ggsave('/data/jux/BBL/projects/pncSingleFuncParcel/Replication/Revision/Figures/AgePrediction_CorrACC_AtlasLabel.tiff', width = 17, height = 15, dpi = 600, units = "cm");
