...
Fig
ggsave('/data/jux/BBL/projects/pncSingleFuncParcel/Replication/results/Figures/EFAccuracyPrediction_CorrACC_AtlasLabel.tiff', width = 17, height = 15, dpi = 600, units = "cm");
