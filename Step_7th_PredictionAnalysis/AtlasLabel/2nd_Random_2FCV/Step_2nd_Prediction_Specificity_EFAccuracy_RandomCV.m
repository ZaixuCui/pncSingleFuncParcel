...
EFPrediction_ResFolder = [ReplicationFolder '/Revision/PredictionAnalysis/AtlasLabel/2Fold_RandomCV_EFAccuracy'];
...
% Permutation test
EFPrediction_Permutation_ResFolder = [ReplicationFolder '/Revision/PredictionAnalysis/AtlasLabel/2Fold_RandomCV_EFAccuracy_Permutation'];
for i = 0:999
    i
