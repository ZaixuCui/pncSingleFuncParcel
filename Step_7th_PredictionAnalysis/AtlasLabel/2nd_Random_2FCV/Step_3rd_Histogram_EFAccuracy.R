...
# Actual accuracy
Actual_Data = readMat(paste0(PredictionFolder, '/AtlasLabel/2Fold_RandomCV_EFAccuracy/2Fold_RandomCV_ParCorr_MAE.mat'));
...
ggplot(ActualData) +
    ...
    scale_x_continuous(limits = c(0.34, 0.48), breaks = c(0.34, 0.41, 0.48), labels = c('0.34', '0.41', '0.48'))
ggsave('/data/jux/BBL/projects/pncSingleFuncParcel/Replication/Revision/Figures/ActualCorr_EFAccuracy_RandomCV_AtlasLabel.pdf', width = 17, height = 15, dpi = 600, units = "cm");

# Permutation test accuracy
Permutation_Data = readMat(paste0(PredictionFolder, '/AtlasLabel/2Fold_RandomCV_EFAccuracy_Permutation/2Fold_RandomCV_ParCorr_MAE_Permutation.mat'));
...
ggsave('/data/jux/BBL/projects/pncSingleFuncParcel/Replication/Revision/Figures/PermutationCorr_EFAccuracy_RandomCV_AtlasLabel.pdf', width = 17, height = 15, dpi = 600, units = "cm");
