...
save([VisualizeFolder '/w_Brain_EFAccuracy.mat'], 'w_Brain_EFAccuracy');
...
%%%%%%%%%%%%%%%%%%
w_Brain_EFAccuracy_lh = zeros(10242, 1);
w_Brain_EFAccuracy_lh(Index_l) = w_Brain_EFAccuracy(1:length(Index_l));
w_Brain_EFAccuracy_rh = zeros(10242, 1);
w_Brain_EFAccuracy_rh(Index_r) = w_Brain_EFAccuracy(length(Index_l) + 1:end);
w_Brain_EFAccuracy_WholeBrain = [w_Brain_EFAccuracy_lh w_Brain_EFAccuracy_rh];
