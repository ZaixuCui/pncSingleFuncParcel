...
ggsave('/data/jux/BBL/projects/pncSingleFuncParcel/Replication/results/Figures/AgePrediction_CorrACC_AtlasLabel_Kong.tiff', width = 17, height = 15, dpi = 600, units = "cm");
