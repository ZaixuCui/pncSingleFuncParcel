...
# Actual accuracy
Actual_Data = readMat(paste0(PredictionFolder, '/AtlasLabel_Kong/2Fold_RandomCV_EFAccuracy/2Fold_RandomCV_ParCorr_MAE.mat'));
...
ggplot(ActualData) +
    ...
    scale_x_continuous(limits = c(0.32, 0.46), breaks = c(0.32, 0.39, 0.46), labels = c('0.32', '0.39', '0.46'))
ggsave('/data/jux/BBL/projects/pncSingleFuncParcel/Replication/Revision/Figures/ActualCorr_EFAccuracy_RandomCV_AtlasLabel_Kong.pdf', width = 17, height = 15, dpi = 600, units = "cm");

# Permutation test accuracy
Permutation_Data = readMat(paste0(PredictionFolder, '/AtlasLabel_Kong/2Fold_RandomCV_EFAccuracy_Permutation/2Fold_RandomCV_ParCorr_MAE_Permutation.mat'));
...
ggsave('/data/jux/BBL/projects/pncSingleFuncParcel/Replication/Revision/Figures/PermutationCorr_EFAccuracy_RandomCV_AtlasLabel_Kong.pdf', width = 17, height = 15, dpi = 600, units = "cm");
