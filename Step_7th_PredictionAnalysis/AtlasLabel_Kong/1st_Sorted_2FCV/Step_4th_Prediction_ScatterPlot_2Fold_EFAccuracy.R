...
PredictionFolder <- paste0(WorkingFolder, '/AtlasLabel_Kong/2Fold_Sort_EFAccuracy');
...
Fig
ggsave('/data/jux/BBL/projects/pncSingleFuncParcel/Replication/Revision/Figures/EFAccuracyPrediction_CorrACC_AtlasLabel_Kong.tiff', width = 17, height = 15, dpi = 600, units = "cm");
