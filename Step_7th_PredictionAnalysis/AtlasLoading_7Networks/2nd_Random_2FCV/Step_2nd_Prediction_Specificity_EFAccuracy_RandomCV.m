...
EFPrediction_ResFolder = [ReplicationFolder '/Revision/PredictionAnalysis/AtlasLoading_7Networks/2Fold_RandomCV_EFAccuracy'];
...
for i = 0:99
    ...
    [ParCorr_Actual_Fold0, ~] = partialcorr(Prediction_Fold0.Predict_Score', EFAccuracy_Fold0, [double(Age_Fold0) double(Sex_Fold0) double(Motion_Fold0)]);
    [ParCorr_Actual_Fold1, ~] = partialcorr(Prediction_Fold1.Predict_Score', EFAccuracy_Fold1, [double(Age_Fold1) double(Sex_Fold1) double(Motion_Fold1)]);
...
% Permutation test
EFPrediction_Permutation_ResFolder = [ReplicationFolder '/Revision/PredictionAnalysis/AtlasLoading_7Networks/2Fold_RandomCV_EFAccuracy_Permutation'];
for i = 0:999
    i
    ...
    [ParCorr_Permutation_Fold0, ~] = partialcorr(Prediction_Fold0.Predict_Score', EFAccuracy_Fold0, [double(Age_Fold0) double(Sex_Fold0) double(Motion_Fold0)]);
    [ParCorr_Permutation_Fold1, ~] = partialcorr(Prediction_Fold1.Predict_Score', EFAccuracy_Fold1, [double(Age_Fold1) double(Sex_Fold1) double(Motion_Fold1)]);
