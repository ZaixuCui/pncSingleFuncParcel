...
# Actual accuracy
Actual_Data = readMat(paste0(PredictionFolder, '/AtlasLoading_7Networks/2Fold_RandomCV_Age/2Fold_RandomCV_ParCorr_MAE_Actual.mat'));
...
ggplot(ActualData) +
    ...
    scale_x_continuous(limits = c(0.59, 0.69), breaks = c(0.59, 0.64, 0.69), labels = c('0.59', '0.64', '0.69'))
ggsave('/data/jux/BBL/projects/pncSingleFuncParcel/Replication/Revision/Figures/ActualCorr_Age_RandomCV_7Networks.pdf', width = 17, height = 15, dpi = 600, units = "cm");

# Permutation test accuracy
Permutation_Data = readMat(paste0(PredictionFolder, '/AtlasLoading_7Networks/2Fold_RandomCV_Age_Permutation/2Fold_RandomCV_ParCorr_MAE_Permutation.mat'));
...
ggsave('/data/jux/BBL/projects/pncSingleFuncParcel/Replication/Revision/Figures/PermutationCorr_Age_RandomCV_7Networks.pdf', width = 17, height = 15, dpi = 600, units = "cm");
