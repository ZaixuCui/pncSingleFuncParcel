...
AgePrediction_ResFolder = [ReplicationFolder '/Revision/PredictionAnalysis/AtlasLoading_7Networks/2Fold_RandomCV_Age'];
...
for i = 0:99
    ...
    [ParCorr_Actual_Fold0, ~] = partialcorr(Prediction_Fold0.Predict_Score', Age_Fold0, [double(Sex_Fold0) double(Motion_Fold0)]);
    [ParCorr_Actual_Fold1, ~] = partialcorr(Prediction_Fold1.Predict_Score', Age_Fold1, [double(Sex_Fold1) double(Motion_Fold1)]);
...
% Permutation test
AgePrediction_Permutation_ResFolder = [ReplicationFolder '/Revision/PredictionAnalysis/AtlasLoading_7Networks/2Fold_RandomCV_Age_Permutation'];
for i = 0:999
    i
    ...
    [ParCorr_Permutation_Fold0, ~] = partialcorr(Prediction_Fold0.Predict_Score', Age_Fold0, [double(Sex_Fold0) double(Motion_Fold0)]);
    [ParCorr_Permutation_Fold1, ~] = partialcorr(Prediction_Fold1.Predict_Score', Age_Fold1, [double(Sex_Fold1) double(Motion_Fold1)]);
