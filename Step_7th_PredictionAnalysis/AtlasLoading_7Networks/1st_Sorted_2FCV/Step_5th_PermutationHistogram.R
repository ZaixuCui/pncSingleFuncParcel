...
# Age prediction
AgePrediction_ResFolder = paste0(PredictionFolder, '/AtlasLoading_7Networks/2Fold_Sort_Age');
# Fold 0
...
PermutationData$Line_y = as.numeric(seq(0,176,length.out=1000));
ggplot(PermutationData) +
    ...
    scale_x_continuous(limits = c(-0.4, 0.70), breaks = c(-0.4, 0, 0.4), labels = c('-0.4', '0', '0.4'))
ggsave('/data/jux/BBL/projects/pncSingleFuncParcel/Replication/Revision/Figures/Permutation_Age_Corr_Fold0_7Networks.pdf', width = 17, height = 15, dpi = 600, units = "cm");
...
PermutationData$Line_y = as.numeric(seq(0,186,length.out=1000));
ggplot(PermutationData) +
    ...
    scale_y_continuous(expand = c(0, 0)) +
    scale_x_continuous(limits = c(-0.4, 0.70), breaks = c(-0.4, 0, 0.4), labels = c('-0.4', '0', '0.4'))
ggsave('/data/jux/BBL/projects/pncSingleFuncParcel/Replication/Revision/Figures/Permutation_Age_Corr_Fold1_7Networks.pdf', width = 17, height = 15, dpi = 600, units = "cm");


# EF prediction
EFPrediction_ResFolder = paste0(PredictionFolder, '/AtlasLoading_7Networks/2Fold_Sort_EFAccuracy');
# Fold 0
...
ggsave('/data/jux/BBL/projects/pncSingleFuncParcel/Replication/Revision/Figures/Permutation_EFAccuracy_Corr_Fold0_7Networks.pdf', width = 17, height = 15, dpi = 600, units = "cm");
...
PermutationData = data.frame(x = t(Corr_Fold1_Rand));
PermutationData$Line_x = as.numeric(matrix(Prediction_Fold1$ParCorr.Actual.Fold1, 1, 1000));
PermutationData$Line_y = as.numeric(seq(0,147,length.out=1000));
ggplot(PermutationData) +
    geom_histogram(aes(x = x), bins = 30, color = "#000000", fill = "#000000") +
    geom_line(aes(x = Line_x, y = Line_y, group = 1), size = 1, color = 'red', linetype = "dashed") +
    theme_classic() + labs(x = "", y = "") +
    ...
    scale_y_continuous(expand = c(0, 0)) +
    scale_x_continuous(limits = c(-0.3, 0.50), breaks = c(-0.3, 0, 0.3), labels = c('-0.3', '0', '0.3'))
ggsave('/data/jux/BBL/projects/pncSingleFuncParcel/Replication/Revision/Figures/Permutation_EFAccuracy_Corr_Fold1_7Networks.pdf', width = 17, height = 15, dpi = 600, units = "cm");
