...
PredictionFolder <- paste0(WorkingFolder, '/AtlasLoading_7Networks/2Fold_Sort_EFAccuracy');
...
Fig
ggsave('/data/jux/BBL/projects/pncSingleFuncParcel/Replication/Revision/Figures/EFAccuracyPrediction_CorrACC_7Networks.tiff', width = 17, height = 15, dpi = 600, units = "cm");
