...
ggsave('/data/jux/BBL/projects/pncSingleFuncParcel/Replication/Revision/Figures/Variability_Loading_Mean_Violin.tiff', width = 20, height = 15, dpi = 600, units = "cm");
