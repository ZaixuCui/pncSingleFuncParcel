...
SystemName = {'Default mode 1', 'Visual 1', 'Motor 1', 'Default mode 2', 'Visual 2', ...
              'Ventral attention 1', 'Limbic', 'Motor 2', 'Frontoparietal 1', ...
              'Motor 3', 'Frontoparietal 2', 'Dorsal attention 1', 'Ventral attention 2', ...
              'Default mode 3', 'Dorsal attention 2', 'Frontoparietal 3', 'Frontoparietal 4'};
ColorPlate = {'242 139 168', '137 63 153', '107 171 214', '226 57 93', '102 5 122',  ...
              '217 117 242', '235 226 151', '33 113 181', '244 197 115', '7 69 132', ...
              '229 157 41', '65 171 93', '206 28 249', '170 12 61', '0 109 44', ...
              '232 130 7', '204 109 14'};
for i = 1:17
